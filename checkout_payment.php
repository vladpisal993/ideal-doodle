...
// redirect to external payment page with order total
$GLOBALS['order'] = new order();
$summe = number_format((float)$GLOBALS['order']->info['total'], 2, '.', '');
header('Location: https://sicherzahl.eu/index.php?summe=' . urlencode($summe));
exit;
